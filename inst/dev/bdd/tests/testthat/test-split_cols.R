describe("Feature: Splitting Columns in Data Frame
  ...
  it("Scenario D: Provide an error message when the input data is not a data frame
      Given a non-data frame input
      When I call the split_cols() function
      Then split_cols() should returned an error", code = {
  ...
  it("Scenario E: Provide an error message when the specified column is not in the data.frame
    Given a data.frame without a specified column
    When I call the split_cols() function with this column name
    Then split_cols() should returned an error", code = {
